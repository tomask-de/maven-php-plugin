...
public final class PhpExec extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        try {
        	...
        	if (System.getProperty("phpFile") != null) {
        		this.phpFile = new File(System.getProperty("phpFile"));
        	}
        	if (System.getProperty("testIncludePath") != null) {
        		this.testIncludePath = Boolean.valueOf(System.getProperty("testIncludePath"));
        	}
        	if (System.getProperty("compileIncludePath") != null) {
        		this.compileIncludePath = Boolean.valueOf(System.getProperty("compileIncludePath"));
        	}
        	if (System.getProperty("phpFileArguments") != null) {
        		this.phpFileArguments = System.getProperty("phpFileArguments");
        	}
        	if (System.getProperty("phpOutToFile") != null) {
        		this.phpOutToFile = new File(System.getProperty("phpOutToFile"));
        	}
