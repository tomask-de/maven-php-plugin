...
public interface IPhpdocService extends IService {
     ...
     * @throws org.codehaus.plexus.configuration.PlexusConfigurationException thrown if configuration fails.
     * @throws org.codehaus.plexus.component.repository.exception.ComponentLookupException thrown if configuration fails.
     */
