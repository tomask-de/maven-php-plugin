...
public class ProjectPhpExecution implements IProjectPhpExecution {
     ...
     * 
     * @throws org.codehaus.plexus.configuration.PlexusConfigurationException thrown on errors while creating the executable
     * @throws org.codehaus.plexus.component.repository.exception.ComponentLookupException  thrown on errors while creating the executable
     */
     ...
     * @param mavenSession the maven session.
     * @throws org.codehaus.plexus.component.configurator.expression.ExpressionEvaluationException thrown on maven property errors
     */
     ...
     * @throws org.codehaus.plexus.component.configurator.expression.ExpressionEvaluationException thrown on errors.
     * @since 2.0.1
     */
     ...
     * @throws org.apache.maven.project.ProjectBuildingException thrown if there are problems creating the project
     * @since 2.0.1
     */
     ...
     * @throws org.codehaus.plexus.component.configurator.expression.ExpressionEvaluationException thrown on configuration errors
     */
