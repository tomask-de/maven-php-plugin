...
public class PearChannel implements IPearChannel {
     ...
     * @param a alias
     * @param s summary
     * @throws org.phpmaven.exec.PhpException thrown on initialization errors.
     */
...
//                    this.validationPackage = x;
     ...
     * @throws org.phpmaven.exec.PhpCoreException thrown on xml errors.
     */
     ...
     * 
     * @throws org.phpmaven.exec.PhpException thrown on php execution errors.
     */
     ...
     * @throws org.phpmaven.exec.PhpException php exception
     */
     ...
     * @throws org.phpmaven.exec.PhpException thrown if php execution failes.
     */
     ...
     * @throws org.phpmaven.exec.PhpException thrown if the php execution fails.
     */
