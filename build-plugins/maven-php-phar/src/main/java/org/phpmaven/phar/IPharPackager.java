...
public interface IPharPackager {
     ...
     * 
     * @throws org.phpmaven.exec.PhpException thrown if the packaging failed.
     * @throws org.codehaus.plexus.component.repository.exception.ComponentLookupException thrown if the configuration failed.
     * @throws org.codehaus.plexus.configuration.PlexusConfigurationException thrown if the configuration failed.
     */
     ...
     * 
     * @throws org.phpmaven.exec.PhpException thrown if the reading failed.
     * @throws org.codehaus.plexus.component.repository.exception.ComponentLookupException thrown if the configuration failed.
     * @throws org.codehaus.plexus.configuration.PlexusConfigurationException thrown if the configuration failed.
     */
     ...
     * @param log The logger.
     * 
     * @throws org.phpmaven.exec.PhpException thrown if the extraction failed.
     * @throws org.codehaus.plexus.component.repository.exception.ComponentLookupException thrown if the configuration failed.
     * @throws org.codehaus.plexus.configuration.PlexusConfigurationException thrown if the configuration failed.
     */
