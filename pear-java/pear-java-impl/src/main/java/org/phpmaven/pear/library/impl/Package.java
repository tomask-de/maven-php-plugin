...
public class Package implements IPackage {
        ...
        if (this.versions == null) {
            ...
            try {
                ...
                for (final Xpp3Dom child : dom.getChildren("r")) {
                    ...
                    final IPackageVersion pkgVersion = this.pearUtility.createPackageVersion();
                    pkgVersion.initialize(this.pearUtility, this.pearChannel, this);
                    final IVersion version = this.pearUtility.createVersion();
        ...
        if (this.maintainers == null) {
            ...
            try {
                ...
                for (final Xpp3Dom child : dom.getChildren("m")) {
                    final IMaintainer mt = this.pearUtility.createMaintainer();
     ...
     * @return pear version
     */
    protected static String convertMavenVersionToPearVersion(String src) {
        int pos = 0;
     ...
     */
    protected static String convertPearVersionToMavenVersion(String src) {
        int pos = 0;
        final StringBuffer sb = new StringBuffer();
        final char[] chars = src.toCharArray();
    ...
    private static final class PearVersionComparator implements Comparator<String> {
        ...
        public int compare(String o1, String o2) {
            try {
                final org.eclipse.aether.version.Version v1 = SCHEME.parseVersion(convertPearVersionToMavenVersion(o1));
                final org.eclipse.aether.version.Version v2 = SCHEME.parseVersion(convertPearVersionToMavenVersion(o2));
