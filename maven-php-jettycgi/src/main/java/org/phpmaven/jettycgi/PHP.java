...
// this class is a fixed variant of org.mortbay.servlet.cgi to let us
// cleanly invoke php-cgi executable
// Copyright 2006 Mort Bay Consulting Pty. Ltd.

package org.phpmaven.jettycgi;
...
public class PHP extends HttpServlet
{
  ...
  public void init() throws ServletException
  {
      ...
      final String[] path = System.getProperty("phpIncludePath", "").split(";");
      for (String inc : path)
      {
          ...
          this.includePath += new File(inc).getAbsolutePath();
      }
      // PHP-FIX-END
      _env=new EnvList();
