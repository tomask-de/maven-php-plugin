...
public class ArgumentsV345Test extends AbstractVersionTestCase {
     ...
     * The phpunit version.
     */
    private static final String PHPUNIT_VERSION = "3.4.5";
    ...
    public void testPhpunitOrgCreation() throws Exception {
        ...
        final MavenSession session = this.createSimpleSession("phpunit/pom-345-arguments");
        final IPhpunitConfiguration config = factory.lookup(
                IPhpunitConfiguration.class,
                IComponentFactory.EMPTY_CONFIG,
                session);
        final Verifier verifier = this.getVerifier("phpunit/pom-345-arguments");
