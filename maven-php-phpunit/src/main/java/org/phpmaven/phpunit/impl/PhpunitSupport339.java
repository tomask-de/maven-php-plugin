...
/**
 * Phpunit support for <= 3.3.9.
 * 
 * @author Martin Eisengardt <Martin.Eisengardt@googlemail.com>
 * @since 2.0.0
 */
@Component(role = IPhpunitSupport.class, instantiationStrategy = "per-lookup", hint = "PHP_EXE_V3.3.9")
public class PhpunitSupport339 extends AbstractPhpunitExeSupport {
